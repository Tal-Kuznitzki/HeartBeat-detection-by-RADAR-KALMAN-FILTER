function [] = EllipsePlotter(radar_i, radar_q,radar_i_centered,radar_q_centered,radar_i_fitted,radar_q_fitted)
        ...
        subplot(3, 1, 1);
        scatter(radar_i, radar_q,3,'filled'); 
        ...
        axis equal;
        subplot(3,1,2);
        scatter(radar_i_centered, radar_q_centered,3,'filled'); % 5 is the marker size
        ...
        axis equal;
        subplot(3,1,3);
        scatter(radar_i_fitted, radar_q_fitted,3,'filled'); % 5 is the marker size
